...
Once you have the package installed, you can launch any of the Shiny applications to interactively process and analyze your insect sound recordings. For example, you can run the import tool like this:
